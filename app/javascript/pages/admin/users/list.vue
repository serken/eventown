...
export default {
  ...
  methods: {
    ...
    deleteItemConfirm: function() {
      this.$api.deleteUser(this.editedItem.id).then((data) => {
        this.fetchData()
      })
      this.closeDelete()
    },
    ...
    save: function() {
      if (this.editedIndex > -1) {
        this.$api.updateUser(this.editedItem.id, this.editedItem).then((data) => {
          this.fetchData()
        })
      } else {
        this.$api.createUser(this.editedItem).then((data) => {
          this.fetchData()
        })
      }
      this.close()
